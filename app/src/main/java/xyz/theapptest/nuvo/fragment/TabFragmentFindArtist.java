...
public class TabFragmentFindArtist extends AppCompatActivity {
...
/*     //   toolbar1 = (android.support.v7.widget.Toolbar)findViewById(R.id.toolbar_top);
    ...
    private void setupViewPager(ViewPager viewPager) {
        TabadapterArtistFind adapter = new TabadapterArtistFind(getSupportFragmentManager());
        adapter.addFrag(new Fragment_CriteriaArtist(), "Find");
        adapter.addFrag(new Activity_Criteradetails(), "Jobs");
...
class TabadapterArtistFind extends FragmentPagerAdapter {
    private final List<Fragment> mFragmentList = new ArrayList<>();
    private final List<String> mFragmentTitleList = new ArrayList<>();

    public TabadapterArtistFind(FragmentManager manager) {
        super(manager);
    }
